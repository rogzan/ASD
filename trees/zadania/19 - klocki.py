# Dany jest ciąg klocków (K1, . . . , Kn). Klocek Ki zaczyna sie na pozycji ai i ciągnie się do pozycji bi
# (wszystkie pozycje to nieujemne liczby naturalne) oraz ma wysokość 1. Klocki układane są po kolei–jeśli klocek
# nachodzi na któryś z poprzednich, to jest przymocowywany na szczycie poprzedzajacego klocka). Na przykład dla klocków
# o pozycjach (1, 3), (2, 5), (0, 3), (8, 9), (4, 6) powstaje konstrukcja o wysokosci trzech klocków. Proszę zaimplementować
# funkcję bricks(K), która oblicza wysokość powstałej konstrukcji (Kto lista par(ai, bi), opisujących kolejne klocki).
# Kod będzie uruchamiany. Na przykład wywołanie:bricks( [ (1, 3), (2, 5), (0, 3), (8, 9), (4, 6)] ) powinno zwrócić liczbę 3.
