# Proszę zaimplementować klasę IntervalSums, która przechowuje tablicę n liczb (na pozycjach od 0 don−1),
# pozwala zmieniać zadane liczby oraz obliczać sumę liczb na pozycjach od i do j.Państwa kod będzie uruchamiany.
# Proszę zaimplementować następujące funckcje w klase IntervalSums (moż-na też dopisać inne klasy i/lub funkcje):
